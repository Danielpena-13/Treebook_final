...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //Localizacion UDEA!!!
        LatLng udea = new LatLng(6.2672096,-75.5674717);
        mMap.addMarker(new MarkerOptions().position(udea).title("Universidad de Antioquia")
                .snippet("Alma Mater").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_launcher_round)));
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(udea,14));
